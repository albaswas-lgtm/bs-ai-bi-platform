const CACHE_NAME = 'bs-bi-platform-v2-3-cross-device-fix';
...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){
    ...
    document.addEventListener('keydown',function(e){if(e.key==='Escape'){closeSaveModal();if(document.body.classList.contains('presentation')){document.body.classList.remove('presentation');if(window.openPage)openPage('homePage')}}});
  });
})();
<\/script>`;
